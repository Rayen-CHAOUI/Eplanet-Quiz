...
def admin_signup_view(page: ft.Page):
    error_text = ft.Text("", color=ft.Colors.RED_400, size=12)
 
    def do_signup(_):
        success, msg, _ = register_admin(full_name.value, password.value, level.value)
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ...
                            ft.Text("Admin Platform", size=40, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                            ft.Text("Create your admin account", size=18, color=ft.Colors.GREY_800),
